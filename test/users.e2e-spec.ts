...
describe('UserController (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    app = testContext.app;
    userModel = testContext.userModel;
  ...
  describe('GET /users', () => {
    ...
    it('should return all users', async () => {
      ...
      await userModel.create(usersData[0]);
      await userModel.create(usersData[1]);
  ...
  describe('POST /users', () => {
    it('should create a new user', async () => {
      ...
      const responseBody = response.body as UserEntity;
      ...
      const savedUser = await UserModel.findByPk(responseBody.id);
